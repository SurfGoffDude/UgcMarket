    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cover_image', models.ImageField(blank=True, null=True, upload_to='creator_covers/', verbose_name='cover image')),
                ('is_online', models.BooleanField(default=False, verbose_name='online status')),
                ('available_for_hire', models.BooleanField(default=True, verbose_name='available for hire')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estimated_time', models.CharField(help_text='Например: 2-3 дня, 1 неделя и т.д.', max_length=100, verbose_name='Примерное время выполнения')),
                ('allows_modifications', models.BooleanField(default=True, verbose_name='Разрешены правки')),
                ('modifications_price', models.DecimalField(blank=True, decimal_places=2, help_text='Стоимость заказа с возможностью внесения правок', max_digits=10, null=True, verbose_name='Цена с правками')),
