...
const categories = [
  { icon: Video, name: 'Видео от блогеров', count: '2,500+', color: 'from-[var(--accent-500)] to-[var(--accent-600)]' },
  { icon: Mic, name: 'Озвучка', count: '1,200+', color: 'from-[var(--secondary-500)] to-[var(--primary-500)]' },
  { icon: Music, name: 'Музыка для Reels', count: '800+', color: 'from-[var(--success-500)] to-[var(--success-600)]' },
  { icon: Scissors, name: 'Монтаж', count: '1,800+', color: 'from-[var(--warning-500)] to-[var(--warning-600)]' },
  { icon: Image, name: 'Интро и анимация', count: '950+', color: 'from-[var(--primary-500)] to-[var(--secondary-500)]' },
  { icon: Youtube, name: 'Обложки для YouTube', count: '650+', color: 'from-[var(--accent-500)] to-[var(--accent-700)]' },
];
